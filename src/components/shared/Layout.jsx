          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-gray-500">
                ...
                <Link to="/how-it-works" className="block hover:text-blue-600">How It Works</Link>
              </div>
            </div>
            <div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-400 mb-4">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <img src="https://upload.wikimedia.org/wikipedia/commons/f/f2/Google_Pay_Logo.svg" alt="Google Pay" className="h-7 object-contain opacity-80" />
                </div>
              </div>
            </div>
