...
import { MapPin, Briefcase, ShieldCheck, Clock, Star, Award } from 'lucide-react';
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-4 mt-2 flex-wrap">
                    ...
                    {provider.experience_years > 0 && (
                      <span className="flex items-center gap-1 text-sm text-muted-foreground">
                        <Briefcase className="w-4 h-4" /> {provider.experience_years} years experience
                      </span>
                    )}
                  </div>
                </div>
              ...
              <div className="bg-card rounded-xl border border-border/50 p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {provider.certifications.map((cert, i) => (
                    <Badge key={i} variant="outline" className="bg-primary/5">{cert}</Badge>
                  ))}
                </div>
              </div>
            )}
